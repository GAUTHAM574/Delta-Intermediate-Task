    ...
    function game() {
        ...
        document.getElementById('user-name').innerHTML = document.getElementById('player_name').value;
        ...
        setInterval(function () {
            ...
            if (player.y - player.radius <= 0 || player.y + player.radius >= canvas.height) {
                ...
                //checking for life
                if (hearts <= 0) {
                    //users.push(document.getElementById('player_name').value);
    ...
    // document.getElementById('reset').addEventListener("click", game);
